...
| `bzip2` | Archive & Compression | High-ratio block-sorting file compressor | Long-term cold database archiving and archive integrity validation | [bzip2.md](docs/commands/bzip2.md) |
